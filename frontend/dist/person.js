            ...
            var h = Object(p.kea)({
                ...
                reducers: function() {
                    return {
                        initialPathname: [
                            function(e) {
                                return m.router.selectors.location(e).pathname
                            },
                            {
                                noop: function(e) {
                                    return e
                ...
                actionToUrl: function(e) {
                    ...
                    return {
                        setProperties: function() {
                            return [m.router.values.location.pathname, t.propertiesForUrl]
                        },
                ...
                urlToAction: function(e) {
                    ...
                    return {
                        '*': function(e, r) {
                            try {
                                if (m.router.values.location.pathname !== n.initialPathname) return
                            } catch (e) {
                                return
                            }
                                                ...
                                                switch ((e.prev = e.next)) {
                                                    case 0:
                                                        return (
                                                            ...
                                                            (e.next = 5),
                                                            v.a.get(''.concat(i.apiUrl || 'api/event/', '?').concat(s))
                                                        )
                                                    case 5:
                                                        ;(l = e.sent),
                                                            n(),
            ...
            function v(e) {
                var t = e.property,
                    ...
                    s = Object(i.combineUrl)(
                        ...
                        m(m({}, r), {}, { properties: m(m({}, r.properties), {}, a()({}, t, n)) })
                    ).url
                return o.a.createElement(
                    p.a,
                    {
            ...
            function d() {
                return c.a.createElement(
                    ...
                    c.a.createElement(
                        ...
                        ' ',
                        c.a.createElement(m.a, { to: '/setup' }, 'click here to set PostHog up on your app')
                    )
                )
            }
            var E = n(333),
            ...
            function f(e) {
                ...
                return (
                    Object(o.useEffect)(
                        function() {
                            var e = ''
                            ;(e = t ? 'api/person/by_distinct_id/?distinct_id='.concat(t) : 'api/person/'.concat(n)),
                                l.a.get(e).then(v)
                        },
                        [t, n]
                    ),
                    m
                        ? i.a.createElement(
                              ...
                              i.a.createElement('h1', null, m.name),
                              i.a.createElement(
                                  'div',
                                  { style: { maxWidth: 750 } },
                                  i.a.createElement(u.a, { properties: m.properties }),
                                  i.a.createElement(
                                      'table',
                                      { className: 'table' },
                                      i.a.createElement(
                                          ...
                                          i.a.createElement(
                                              'tr',
                                              null,
                                              i.a.createElement('td', null, 'Distinct IDs'),
                                              i.a.createElement(
                                                  'td',
                                                  null,
                                                  m.distinct_ids.map(function(e) {
                                                      return i.a.createElement(
                                                          'pre',
                                                          { style: { margin: 0 }, key: e },
                                                          e
                                                      )
                                                  })
                                              )
                              ...
                              i.a.createElement(s.a, { fixedFilters: { person_id: m.id } })
                          )
                        : null
                )
            }
